...
void plotTimingResolution(){
  ...
  int iColorsHG2[3] = {kBlack, kBlack, kBlack};
  ...
  tH100.DrawLatex(0.4,0.75, Form("Si 100um  A = %.2f  C = %.3f", X_MIP_100->GetParameter(0), HGC_MIP_100->GetParameter(1)));
  tH200.DrawLatex(0.4,0.70, Form("Si 200um  A = %.2f  C = %.3f", X_MIP_200->GetParameter(0), HGC_MIP_200->GetParameter(1)));
  tH300.DrawLatex(0.4,0.65, Form("Si 300um  A = %.2f  C = %.3f", X_MIP_300->GetParameter(0), HGC_MIP_300->GetParameter(1)));
  ...
  tBX.DrawLatex(0.50,0.85, "#sigma_{t} (ns) = A/x #oplus C");
  tB100.DrawLatex(0.5,0.75, Form("A = %.2f  C = %.3f", X_SoN_100->GetParameter(0), X_SoN_100->GetParameter(1)));
  // tH200.DrawLatex(0.4,0.75, Form("HGC 200um A = %.2f C = %.3f", X_SoN_200->GetParameter(0), X_SoN_200->GetParameter(1)));
