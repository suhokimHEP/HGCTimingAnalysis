...
void comparePlots_Timing(){
  ...
  nameOptions.push_back("CSF30LBA10");
  nameOptions.push_back("CSF30LEA10");
  nameOptions.push_back("CSF30LBA15");
  nameOptions.push_back("CSF30LEA15");
  ...
  for(int iR=0; iR<nOptions; ++iR){
    for(int ij=0; ij<nFiles; ++ij){
      std::string inFileName =  "../../test/timingStudies/16JuneParameters/"+nameOptions.at(iR)+"/JOB_"+nameFiles.at(ij)+"_3fC/OutTimeHGC_RecHits_"+nameFiles.at(ij)+"_3fC.root";
