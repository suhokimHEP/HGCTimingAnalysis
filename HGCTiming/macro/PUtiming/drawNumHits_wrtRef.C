...
void drawNumHits_wrtRef(){
  ...
  std::string inputFolderPU = "ACfix_bkp210FixTime_double_140and200PU_allEta";     
  std::string inputFolder = "ACfix_bkp210FixTime_double_0PU_allEta";               
  if(pdgID == "130") inputFolderPU = "ACfix_bkp210FixTime_double_140and200PU_allEta_fixVtxZ";     

  bool aged = false;

  if(aged){
    inputFolderPU = inputFolderPU + "_aged";     
    if(pdgID == "130") inputFolderPU = "ACfix_bkp210FixTime_double_140and200PU_allEta_aged_fixVtxZ";     
    inputFolder = inputFolder + "_aged";         
  }

  TFile* inF[5];

  // inF[0] = TFile::Open(("../../test/testPU/bkp280FixTime/PDG"+pdgID+"_pt5_140PU_lowEta/JOB_PDG_"+pdgID+"_Pt5_140PU_lowEta/OutTimeHGC_RecHits_PDG_"+pdgID+"_Pt5_140PU_lowEta.root").c_str());
  // inF[1] = TFile::Open(("../../test/testPU/bkp280FixTime/PDG"+pdgID+"_pt5_140PU_highEta/JOB_PDG_"+pdgID+"_Pt5_140PU_highEta/OutTimeHGC_RecHits_PDG_"+pdgID+"_Pt5_140PU_highEta.root").c_str());
  // inF[0] = TFile::Open(("../../test/testPU/bkp10Oct/PDG"+pdgID+"_pt5_140PU_lowEta/JOB_PDG_"+pdgID+"_Pt5_140PU_lowEta/OutTimeHGC_RecHits_PDG_"+pdgID+"_Pt5_140PU_lowEta.root").c_str());
  // inF[1] = TFile::Open(("../../test/testPU/bkp10Oct/PDG"+pdgID+"_pt5_140PU_highEta/JOB_PDG_"+pdgID+"_Pt5_140PU_highEta/OutTimeHGC_RecHits_PDG_"+pdgID+"_Pt5_140PU_highEta.root").c_str());
  // inF[0] = TFile::Open(("../../test/testPU/bkp340FixTime/PDG"+pdgID+"_pt5_140PU_lowEta/JOB_PDG_"+pdgID+"_Pt5_140PU_lowEta/OutTimeHGC_RecHits_PDG_"+pdgID+"_Pt5_140PU_lowEta.root").c_str());
  // inF[1] = TFile::Open(("../../test/testPU/bkp340FixTime/PDG"+pdgID+"_pt5_140PU_highEta/JOB_PDG_"+pdgID+"_Pt5_140PU_highEta/OutTimeHGC_RecHits_PDG_"+pdgID+"_Pt5_140PU_highEta.root").c_str());
  for(int ij=0; ij<2; ++ij){
    /*
    if(ij == 0){
    inF[0] = TFile::Open(("../../test/testPU/bkp310FixTime_double_"+PUname.at(ij)+"PU_thr12fC/PDG_"+pdgID+"_Pt5_"+PUname.at(ij)+"PU_thr12_lowEta/JOB_PDG_"+pdgID+"_Pt5_"+PUname.at(ij)+"PU_thr12_lowEta/OutTimeHGC_RecHits_PDG_"+pdgID+"_Pt5_"+PUname.at(ij)+"PU_thr12_lowEta.root").c_str());
    inF[1] = TFile::Open(("../../test/testPU/bkp310FixTime_double_"+PUname.at(ij)+"PU_thr12fC/PDG_"+pdgID+"_Pt5_"+PUname.at(ij)+"PU_thr12_highEta/JOB_PDG_"+pdgID+"_Pt5_"+PUname.at(ij)+"PU_thr12_highEta/OutTimeHGC_RecHits_PDG_"+pdgID+"_Pt5_"+PUname.at(ij)+"PU_thr12_highEta.root").c_str());
    }
    if(ij == 1){
    inF[2] = TFile::Open(("../../test/testPU/bkp310FixTime_double_"+PUname.at(ij)+"PU_thr12fC/PDG_"+pdgID+"_Pt5_"+PUname.at(ij)+"PU_thr12_lowEta/JOB_PDG_"+pdgID+"_Pt5_"+PUname.at(ij)+"PU_thr12_lowEta/OutTimeHGC_RecHits_PDG_"+pdgID+"_Pt5_"+PUname.at(ij)+"PU_thr12_lowEta.root").c_str());
    inF[3] = TFile::Open(("../../test/testPU/bkp310FixTime_double_"+PUname.at(ij)+"PU_thr12fC/PDG_"+pdgID+"_Pt5_"+PUname.at(ij)+"PU_thr12_highEta/JOB_PDG_"+pdgID+"_Pt5_"+PUname.at(ij)+"PU_thr12_highEta/OutTimeHGC_RecHits_PDG_"+pdgID+"_Pt5_"+PUname.at(ij)+"PU_thr12_highEta.root").c_str());
    }
  }
    */
    if(ij == 0){
      if(aged){
    inF[0] = TFile::Open(("../../test/testPU/"+inputFolderPU+"/JOB_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_lowEta_aged/OutTimeHGC_RecHits_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_lowEta_aged.root").c_str());
    inF[1] = TFile::Open(("../../test/testPU/"+inputFolderPU+"/JOB_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_highEta_aged/OutTimeHGC_RecHits_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_highEta_aged.root").c_str());
      }
      else{
	inF[0] = TFile::Open(("../../test/testPU/"+inputFolderPU+"/JOB_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_lowEta/OutTimeHGC_RecHits_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_lowEta.root").c_str());
	inF[1] = TFile::Open(("../../test/testPU/"+inputFolderPU+"/JOB_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_highEta/OutTimeHGC_RecHits_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_highEta.root").c_str());
      }
    }
    if(ij == 1){
      if(aged){
	inF[2] = TFile::Open(("../../test/testPU/"+inputFolderPU+"/JOB_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_lowEta_aged/OutTimeHGC_RecHits_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_lowEta_aged.root").c_str());
	inF[3] = TFile::Open(("../../test/testPU/"+inputFolderPU+"/JOB_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_highEta_aged/OutTimeHGC_RecHits_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_highEta_aged.root").c_str());
      }
      else{
	inF[2] = TFile::Open(("../../test/testPU/"+inputFolderPU+"/JOB_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_lowEta/OutTimeHGC_RecHits_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_lowEta.root").c_str());
	inF[3] = TFile::Open(("../../test/testPU/"+inputFolderPU+"/JOB_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_highEta/OutTimeHGC_RecHits_PDG_"+pdgID+"_pt5_"+PUname.at(ij)+"PU_highEta.root").c_str());
      }
    }
  }

  //  inF[2] = TFile::Open(("../../../../../../CMSSW_9_2_0/src/HGCTimingAnalysis/HGCTiming/test/CSF20LBA50keep68/JOB_PDG_"+pdgID+"_Pt5_3fC/OutTimeHGC_RecHits_PDG_"+pdgID+"_Pt5_3fC.root").c_str());
  //  inF[4] = TFile::Open(("../../test/testPU/bkp310FixTime_double_0PU_thr12fC/PDG_"+pdgID+"_Pt5_0PU_thr12_allEta/JOB_PDG_"+pdgID+"_Pt5_0PU_thr12_allEta/OutTimeHGC_RecHits_PDG_"+pdgID+"_Pt5_0PU_thr12_allEta.root").c_str());

  if(aged)  inF[4] = TFile::Open(("../../test/testPU/"+inputFolder+"/OutTimeHGC_RecHits_PDG_"+pdgID+"_pt5_0PU_allEta_aged.root").c_str());
  else inF[4] = TFile::Open(("../../test/testPU/"+inputFolder+"/OutTimeHGC_RecHits_PDG_"+pdgID+"_pt5_0PU_allEta.root").c_str());


  for(int ij=0; ij<5; ++ij) std::cout << " file name = " << inF[ij]->GetName() << std::endl;
  ...
  std::string folder = inputFolderPU+"/plotsPU_numHits_"+pdgID;
  ...
  for(int iF=0; iF<3; ++iF){
    ...
    tgReso[iF]->SetMarkerSize(1.2);
    tgReso[iF]->SetMarkerStyle(iStyle[iF]);

    if(iF < 2){
    int numberFile = 0;
    if(iF == 1) numberFile = 2;
    for(int ij=0; ij<2; ++ij){
      TH1F* test  = (TH1F*)inF[numberFile+ij]->Get(("ana/hFractionEvents_Hits_Eta"+etaBin.at(ij)+"_dRadius"+radius).c_str());

      std::cout << "prendo da  file name = " << inF[numberFile+ij]->GetName() 
      ...
      hTime_Eta_dRadius[ij][iF] = (TH1F*)inF[numberFile+ij]->Get(("ana/hTime_Eta_dRadius_Eta"+etaBin.at(ij)+"_dRadius"+radius).c_str());
      hTimeCP_Eta_dRadius[ij][iF] = (TH1F*)inF[numberFile+ij]->Get(("ana/hTimeCP_Eta_dRadius_Eta"+etaBin.at(ij)+"_dRadius"+radius).c_str());
      hTimeCut_Eta_dRadius[ij][iF] = (TH1F*)inF[numberFile+ij]->Get(("ana/hTimeCut_Eta_dRadius_Eta"+etaBin.at(ij)+"_dRadius"+radius).c_str());
      hTimeIntCut_Eta_dRadius[ij][iF] = (TH1F*)inF[numberFile+ij]->Get(("ana/hTimeIntCut_Eta_dRadius_Eta"+etaBin.at(ij)+"_dRadius"+radius).c_str());

      hAverageTime_Eta_dRadius[ij][iF] = (TH1F*)(inF[numberFile+ij]->Get(("ana/hAverageTime_Eta"+etaBin.at(ij)+"_dRadius"+radius+"").c_str()) );
      hAverageTimeCP_Eta_dRadius[ij][iF] = (TH1F*)(inF[numberFile+ij]->Get(("ana/hAverageTimeCP_Eta"+etaBin.at(ij)+"_dRadius"+radius+"").c_str()) );
      hAverageTime_Eta_dRadius_Avg68[ij][iF] = (TH1F*)(inF[numberFile+ij]->Get(("ana/hAverageTime_Eta"+etaBin.at(ij)+"_dRadius"+radius+"_Avg68NoRW").c_str()) );
      hAverageTime_Eta_dRadius_AvgInt[ij][iF] = (TH1F*)(inF[numberFile+ij]->Get(("ana/hAverageTime_Eta"+etaBin.at(ij)+"_dRadius"+radius+"_AvgInt").c_str()) );
      ...
      TH1F* test  = (TH1F*)inF[4]->Get(("ana/hFractionEvents_Hits_Eta"+etaBin.at(0)+"_dRadius"+radius).c_str());
      tgFrEvt[iF]->SetPoint(1, 1.75, test->GetMean());
      test  = (TH1F*)inF[4]->Get(("ana/hFractionEvents_Hits_Eta"+etaBin.at(1)+"_dRadius"+radius).c_str());
      tgFrEvt[iF]->SetPoint(2, 2.75, test->GetMean());
      test->Delete();

      for(int ij=0; ij<2; ++ij){
	iF = 2;
	hTime_Eta_dRadius[ij][iF] = (TH1F*)inF[4]->Get(("ana/hTime_Eta_dRadius_Eta"+etaBin.at(ij)+"_dRadius"+radius).c_str());
	hTimeCP_Eta_dRadius[ij][iF] = (TH1F*)inF[4]->Get(("ana/hTimeCP_Eta_dRadius_Eta"+etaBin.at(ij)+"_dRadius"+radius).c_str());
	hTimeCut_Eta_dRadius[ij][iF] = (TH1F*)inF[4]->Get(("ana/hTimeCut_Eta_dRadius_Eta"+etaBin.at(ij)+"_dRadius"+radius).c_str());
	hTimeIntCut_Eta_dRadius[ij][iF] = (TH1F*)inF[4]->Get(("ana/hTimeIntCut_Eta_dRadius_Eta"+etaBin.at(ij)+"_dRadius"+radius).c_str());
      
	hAverageTime_Eta_dRadius[ij][iF] = (TH1F*)(inF[4]->Get(("ana/hAverageTime_Eta"+etaBin.at(ij)+"_dRadius"+radius+"").c_str()) );
	hAverageTimeCP_Eta_dRadius[ij][iF] = (TH1F*)(inF[4]->Get(("ana/hAverageTimeCP_Eta"+etaBin.at(ij)+"_dRadius"+radius+"").c_str()) );
	hAverageTime_Eta_dRadius_Avg68[ij][iF] = (TH1F*)(inF[4]->Get(("ana/hAverageTime_Eta"+etaBin.at(ij)+"_dRadius"+radius+"_Avg68NoRW").c_str()) );
	hAverageTime_Eta_dRadius_AvgInt[ij][iF] = (TH1F*)(inF[4]->Get(("ana/hAverageTime_Eta"+etaBin.at(ij)+"_dRadius"+radius+"_AvgInt").c_str()) );
  ...
  // gPad->SetLogx();
    ...
    hTime_Eta_dRadius[ij][iP]->GetXaxis()->SetTitle(("time (ns) eta bin "+etaBin.at(ij)).c_str());
    ...
    tLPU.DrawLatex(0.2,0.90, Form("PU %d", PUvalue.at(iP)) );

    if(pdgID == "130") tL.DrawLatex(0.3,0.9, Form("K^{0}_{L}   #rho #leq%d cm    p_{T} = 5GeV", radiusR.at(std::stoi(radius)) ) );
    if(pdgID == "22")  tL.DrawLatex(0.3,0.9, Form("#gamma      #rho #leq%d cm    p_{T} = 5GeV", radiusR.at(std::stoi(radius)) ) );

    legTGM->Draw("same");
    ch_hitsTime[ij][iP]->Print((folder+"/h_hitsTime_pdg_"+pdgID+"_rad_"+radius+"_eta_"+etaBin.at(ij)+"PU_"+PUname.at(iP)+".png").c_str(), "png");
    ch_hitsTime[ij][iP]->Print((folder+"/h_hitsTime_pdg_"+pdgID+"_rad_"+radius+"_eta_"+etaBin.at(ij)+"PU_"+PUname.at(iP)+".pdf").c_str(), "pdf");
    ch_hitsTime[ij][iP]->Print((folder+"/h_hitsTime_pdg_"+pdgID+"_rad_"+radius+"_eta_"+etaBin.at(ij)+"PU_"+PUname.at(iP)+".root").c_str(), "root");

    hTime_Eta_dRadius[ij][iP]->GetXaxis()->SetRangeUser(-3., 5.);
    ch_hitsTime[ij][iP]->Print((folder+"/h_hitsTime_pdg_"+pdgID+"_rad_"+radius+"_eta_"+etaBin.at(ij)+"PU_"+PUname.at(iP)+"zoom.png").c_str(), "png");
    ch_hitsTime[ij][iP]->Print((folder+"/h_hitsTime_pdg_"+pdgID+"_rad_"+radius+"_eta_"+etaBin.at(ij)+"PU_"+PUname.at(iP)+"zoom.pdf").c_str(), "pdf");
    ch_hitsTime[ij][iP]->Print((folder+"/h_hitsTime_pdg_"+pdgID+"_rad_"+radius+"_eta_"+etaBin.at(ij)+"PU_"+PUname.at(iP)+"zoom.root").c_str(), "root");
  ...
  legTGMresoAll->SetTextSize(0.03);
  ...
  legTGMresoFit->SetTextSize(0.03);
  ...
  // gPad->SetLogx();
    ...
    hAverageTime_Eta_dRadius[ij][iP]->GetXaxis()->SetTitle(("average time per shower (ns) eta bin "+etaBin.at(ij)).c_str());
    hAverageTime_Eta_dRadius[ij][iP]->GetXaxis()->SetRangeUser(-0.2, 0.5);
    ...
    tLPU.DrawLatex(0.20,0.90, Form("PU %d", PUvalue.at(iP)) );

    if(pdgID == "130") tL.DrawLatex(0.3,0.90, Form("K^{0}_{L}   #rho #leq%d cm    p_{T} = 5GeV", radiusR.at(std::stoi(radius)) ) );
    if(pdgID == "22")  tL.DrawLatex(0.3,0.90, Form("#gamma      #rho #leq%d cm    p_{T} = 5GeV", radiusR.at(std::stoi(radius)) ) );


    legTGMresoAll->Draw("same");
    ch_Reso_all[ij][iP]->Print((folder+"/h_Reso_all_pdg_"+pdgID+"_rad_"+radius+"_eta_"+etaBin.at(ij)+"PU_"+PUname.at(iP)+".png").c_str(), "png");
    ch_Reso_all[ij][iP]->Print((folder+"/h_Reso_all_pdg_"+pdgID+"_rad_"+radius+"_eta_"+etaBin.at(ij)+"PU_"+PUname.at(iP)+".pdf").c_str(), "pdf");
    ch_Reso_all[ij][iP]->Print((folder+"/h_Reso_all_pdg_"+pdgID+"_rad_"+radius+"_eta_"+etaBin.at(ij)+"PU_"+PUname.at(iP)+".root").c_str(), "root");
  }
  }
  ...
  // gPad->SetLogx();
    ...
    hAverageTime_Eta_dRadius_Avg68[ij][iP]->GetXaxis()->SetTitle(("average time per shower (ns) eta bin "+etaBin.at(ij)).c_str());
    hAverageTime_Eta_dRadius_Avg68[ij][iP]->GetXaxis()->SetRangeUser(-0.2, 0.5);
    ...
    ch_Reso_fit[ij][iP]->Print((folder+"/h_Reso_fit_pdg_"+pdgID+"_rad_"+radius+"_eta_"+etaBin.at(ij)+"PU_"+PUname.at(iP)+".png").c_str(), "png");
    ch_Reso_fit[ij][iP]->Print((folder+"/h_Reso_fit_pdg_"+pdgID+"_rad_"+radius+"_eta_"+etaBin.at(ij)+"PU_"+PUname.at(iP)+".pdf").c_str(), "pdf");
    ch_Reso_fit[ij][iP]->Print((folder+"/h_Reso_fit_pdg_"+pdgID+"_rad_"+radius+"_eta_"+etaBin.at(ij)+"PU_"+PUname.at(iP)+".root").c_str(), "root");

    hAverageTime_Eta_dRadius_Avg68[ij][iP]->GetYaxis()->SetRangeUser(0.1, 500.);
    gPad->SetLogy();
    ch_Reso_fit[ij][iP]->Print((folder+"/h_Reso_fit_pdg_"+pdgID+"_rad_"+radius+"_eta_"+etaBin.at(ij)+"PU_"+PUname.at(iP)+"logY.png").c_str(), "png");
    ch_Reso_fit[ij][iP]->Print((folder+"/h_Reso_fit_pdg_"+pdgID+"_rad_"+radius+"_eta_"+etaBin.at(ij)+"PU_"+PUname.at(iP)+"logY.pdf").c_str(), "pdf");
    ch_Reso_fit[ij][iP]->Print((folder+"/h_Reso_fit_pdg_"+pdgID+"_rad_"+radius+"_eta_"+etaBin.at(ij)+"PU_"+PUname.at(iP)+"logY.root").c_str(), "root");
  }
  }

  TLegend *legReso = new TLegend(0.70,0.30,0.80,0.53,NULL,"brNDC");
  legReso->SetTextFont(42);
  legReso->SetTextSize(0.03);
  legReso->SetFillColor(kWhite);
  legReso->SetLineColor(kWhite);
  legReso->SetShadowColor(kWhite);
  for(int iF=0; iF<3; ++iF)
    legReso->AddEntry(tgFrEvt[iF], Form("%d PU",PUvalue.at(iF)), "p");

  TLegend *legResoD = new TLegend(0.23,0.70,0.33,0.93,NULL,"brNDC");
  ...
  for(int iF=0; iF<3; ++iF)
    legResoD->AddEntry(tgFrEvt[iF], Form("%d PU",PUvalue.at(iF)), "l");
  ...
  if(pdgID == "130") tL.DrawLatex(0.25,0.45, Form("K^{0}_{L}  #rho #leq%dcm   p_{T}=5GeV", radiusR.at(std::stoi(radius)) ) );
  if(pdgID == "22")  tL.DrawLatex(0.25,0.45, Form("#gamma     #rho #leq%dcm   p_{T}=5GeV", radiusR.at(std::stoi(radius)) ) );
  ...
  //  tgReso[iF]->GetYaxis()->SetMaxDigits(2.);
  if(pdgID == "22") tgReso[iF]->GetYaxis()->SetRangeUser(0., 0.05);
  if(iF == 0)  tgReso[iF]->Draw("ap");
  else tgReso[iF]->Draw("p, same");
  }

  if(pdgID == "130") tL.DrawLatex(0.25,0.85, Form("K^{0}_{L}  #rho #leq%dcm   p_{T}=5GeV", radiusR.at(std::stoi(radius)) ) );
  if(pdgID == "22")  tL.DrawLatex(0.25,0.85, Form("#gamma     #rho #leq%dcm   p_{T}=5GeV", radiusR.at(std::stoi(radius)) ) );
  ...
  for(int ij=0; ij<2; ++ij){
    ...
    hTime_Eta_dRadius[ij][0]->GetYaxis()->SetRangeUser(0.1, 1.e+5);
    hTime_Eta_dRadius[ij][1]->GetYaxis()->SetRangeUser(0.1, 1.e+5);
    hTime_Eta_dRadius[ij][2]->GetYaxis()->SetRangeUser(0.1, 1.e+5);
    ...
    latexLabel.DrawLatex(0.20, 0.96, "#font[62]{CMS} #font[52]{Phase-2 Simulation}");
    if(pdgID == "130") {
      tL.DrawLatex(0.63, 0.85, "K^{0}_{L}    p_{T} = 5 GeV");
      tL2.DrawLatex(0.63, 0.75, Form("#rho #leq %dcm   |#eta| #approx %.2f", radiusR.at(std::stoi(radius)), etaValue.at(ij)) );
    }
    if(pdgID == "22") {
      tL.DrawLatex(0.63, 0.85, "#gamma    p_{T} = 5 GeV");
      tL2.DrawLatex(0.63, 0.75, Form("#rho #leq %dcm |#eta| #approx %.2f", radiusR.at(std::stoi(radius)), etaValue.at(ij)) );
    }
  ...
  for(int ij=0; ij<2; ++ij){
    ...
    hTimeIntCut_Eta_dRadius[ij][0]->GetYaxis()->SetRangeUser(0.1, 1.0e+5);
    hTimeIntCut_Eta_dRadius[ij][1]->GetYaxis()->SetRangeUser(0.1, 1.0e+5);
    hTimeIntCut_Eta_dRadius[ij][2]->GetYaxis()->SetRangeUser(0.1, 1.0e+5);
    ...
    // if(pdgID == "130") tL.DrawLatex(0.20,0.86, "|#eta| #approx 1.75   K^{0}_{L}   p_{T} = 5 GeV");
    // if(pdgID == "22")  tL.DrawLatex(0.20,0.86, "|#eta| #approx 1.75   #gamma      p_{T} = 5 GeV");
